...
public class MultiThreadedMergeSort {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Input length: " + sorter.list.length + '\n');

        Integer[] arr = Arrays.copyOf(sorter.list, sorter.list.length);

        // Custom multi-threaded recursive merge sort
        long startTime = System.currentTimeMillis();
        MergeSort.threadedSort(arr);
        long elapsedTime = System.currentTimeMillis() - startTime;
        System.out.println("Custom Multi-threaded Recursive Merge Sort:");
